...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query, DocumentPredicate predicate) const {
        ...
        //сортируем по релевантности или по рейтингу
    ...
    //находим пересечение слов поискового запроса и конкретного документа из базы данных
...
private:
    ...
    //существует только для промежуточных значений ParseQuery
    struct QueryWord {
        string data;
        bool is_minus;
        bool is_stop;
    ...
    //находит ВСЕ соответствующие поисковому запросу документы из базы данных для FindTopDocuments
    template <typename DocumentPredicate>
